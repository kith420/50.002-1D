...
set_property PACKAGE_PIN P5 [get_ports {ext_select[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_select[0]}]

set_property PACKAGE_PIN P10 [get_ports {ext_segment[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[0]}]

set_property PACKAGE_PIN T13 [get_ports {ext_segment[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[1]}]

set_property PACKAGE_PIN R13 [get_ports {ext_segment[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[2]}]

set_property PACKAGE_PIN N12 [get_ports {ext_segment[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[3]}]

set_property PACKAGE_PIN N11 [get_ports {ext_segment[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[4]}]

set_property PACKAGE_PIN T12 [get_ports {ext_segment[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[5]}]

set_property PACKAGE_PIN R12 [get_ports {ext_segment[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[6]}]

set_property PACKAGE_PIN P13 [get_ports {ext_segment[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment[7]}]

set_property PACKAGE_PIN L5 [get_ports {ext_select2[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_select2[0]}]

set_property PACKAGE_PIN N13 [get_ports {ext_segment2[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[0]}]

set_property PACKAGE_PIN R11 [get_ports {ext_segment2[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[1]}]

set_property PACKAGE_PIN R10 [get_ports {ext_segment2[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[2]}]

set_property PACKAGE_PIN M1 [get_ports {ext_segment2[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[3]}]

set_property PACKAGE_PIN M2 [get_ports {ext_segment2[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[4]}]

set_property PACKAGE_PIN N2 [get_ports {ext_segment2[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[5]}]

set_property PACKAGE_PIN N3 [get_ports {ext_segment2[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[6]}]

set_property PACKAGE_PIN P1 [get_ports {ext_segment2[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ext_segment2[7]}]
